...
<div class="px-4 sm:px-6 lg:px-8">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-base font-semibold text-gray-900">Auditor Dashboard</h1>
      <p class="mt-2 text-sm text-gray-700">List Client</p>
    </div>
  </div>
        ...
        <table class="max-w-full divide-y divide-gray-300 w-full align"> <!-- Add w-full here -->
          <thead>
            <tr>
              ...
              <th scope="col" class="px-3 py-3.5 text-mid text-sm font-semibold text-gray-900">Close Period</th>
          ...
          <tbody class="divide-y divide-gray-200">
            <tr>
              ...
              <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">
                ...
                <select class="border rounded px-2 py-1 text-sm text-gray-700 text-center">
             ...
             <td class="text-center px-3 py-4 text-sm whitespace-nowrap text-gray-500">DD/MM/YYYY</td>
             <td class="text-center px-3 py-4 text-sm whitespace-nowrap text-gray-500">MM : HH</td>
