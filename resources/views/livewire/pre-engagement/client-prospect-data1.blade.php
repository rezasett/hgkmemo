...
<div class="mt-6 border-8 overflow-hidden rounded-lg bg-white shadow-sm">
  <div class="px-4 py-5 sm:p-6">
    <div class="grid grid-flow-col grid-rows-3 gap-4">
        ...
        <div class="col-span-2 border-2 flex items-center justify-center text-white bg-blue-700">
        ...
        <div class="col-span-2 border-2 flex items-center justify-center text-white bg-blue-700">
        <a href="{{ route ('livewire.pre-engagement.client-prospect-data3') }}" class="w-full h-full flex items-center justify-center">
            Personnel Allocation
        </a>
        </div>

        <div class="col-span-2 border-2 flex items-center justify-center text-white bg-blue-700">
        <a href="{{ route('livewire.pre-engagement.client-prospect-data6') }}" class="w-full h-full flex items-center justify-center">
            Cost Allocation
        </a>
        </div>
    </div>
