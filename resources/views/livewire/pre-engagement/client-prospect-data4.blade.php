  ...
  <div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700">EQCR Recomendation Detail</p>
      </div>
    ...
    <div class="mt-6 border-8 overflow-hidden rounded-lg bg-white shadow-sm">
     ...
     <table class="w-full border border-gray-300 divide-y divide-gray-300">
        ...
        <tbody class="divide-y divide-gray-200">
          <tr>
            <td class="px-4 py-2 text-sm text-gray-700 border-r border-gray-300">Public Entity</td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 bg-gray-100"></td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 bg-gray-100"></td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300"></td>
          ...
          <tr>
            <td class="px-4 py-2 text-sm text-gray-700 border-r border-gray-300">Banking Industry/IKNB/SOE</td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 bg-gray-100"></td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 bg-gray-100"></td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300"></td>
            <td class="px-4 py-2 text-sm text-gray-700 border-r border-gray-300">
          ...
          <tr>
            <td class="px-4 py-2 text-sm text-gray-700 border-r border-gray-300">Litigation Risk</td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 bg-gray-100"></td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 bg-gray-100"></td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300"></td>
            <td class="px-4 py-2 text-sm text-gray-700 border-r border-gray-300">
          ...
          <tr>
            <td class="px-4 py-2 text-sm text-gray-700 border-r border-gray-300">Going Concern Issue</td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 bg-gray-100"></td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 bg-gray-100"></td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300"></td>
            <td class="px-4 py-2 text-sm text-gray-700 border-r border-gray-300">
          ...
          <tr>
            <td class="px-4 py-2 text-sm text-gray-700 border-r border-gray-300">First Engagement</td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 bg-gray-100"></td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 bg-gray-100"></td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300"></td>
            <td class="px-4 py-2 text-sm text-gray-700 border-r border-gray-300">
          ...
          <tr>
            <td class="px-4 py-2 text-sm text-gray-700 border-r border-gray-300">Audit Opinion Issue</td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 bg-gray-100"></td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 bg-gray-100"></td>
            <td class="w-40 px-4 py-2 text-sm text-gray-700 border-r border-gray-300"></td>
            <td class="px-4 py-2 text-sm text-gray-700 border-r border-gray-300">
