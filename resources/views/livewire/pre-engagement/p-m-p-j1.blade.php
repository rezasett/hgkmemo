  ...
  <div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-2xl font-semibold text-gray-900">PMPJ Detail</h1>
        <p class="mt-2 text-base text-gray-700">Client Name</p>
      </div>
    ...
    {{-- Content --}}
        ...
        <thead>
        <tr>
            <th class="w-50 px-4 py-2 text-left text-sm font-semibold text-gray-900 border border-gray-300 bg-gray-100">
    ...
    {{-- Body --}}
    <!-- Margin Body -->
    <div class="mr-100 mt-4 sm:mt-8 sm:ml-8">
    {{-- Content --}}
        <table class="w-full border border-gray-300 divide-y divide-gray-300">
        <thead>
        <tr>
            <th class="w-50 px-4 py-20 text-left text-sm font-semibold text-gray-900 border border-gray-300">
            Services User
            </th>
            <th class="w-150 px-4 py-20 text-center text-sm font-normal text-gray-900 border border-gray-300">Lorem Ipsum</th>
        </tr>
        <tr>
            <th class="w-50 px-4 py-20 text-left text-sm font-semibold text-gray-900 border border-gray-300">
         ...
         <tr>
            <th class="w-50 px-4 py-20 text-left text-sm font-semibold text-gray-900 border border-gray-300">
            Ministry of Law and Human Rights Deed
            </th>
            <th class="w-150 px-4 py-20 text-center text-sm font-normal text-gray-900 border border-gray-300">Lorem Ipsum</th>
        </tr>
        <tr>
