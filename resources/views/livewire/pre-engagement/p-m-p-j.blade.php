...
<div class="px-4 sm:px-6 lg:px-8">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-2xl font-semibold text-gray-900">PMPJ Dashboard</h1>
    </div>
  </div>
          ...
          <tbody class="divide-y divide-gray-200">
            <tr>
              ...
              <td class="text-center">
                <a href="{{ route('livewire.pre-engagement.p-m-p-j1') }}" class="px-3 py-4 text-sm whitespace-nowrap text-blue-500 hover:text-blue-700">view
                </a>
            </td>
            </tr>
            <tr>
