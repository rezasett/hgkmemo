...
<div class="px-4 sm:px-6 lg:px-8">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-base font-semibold text-gray-900">Client Prospect Result</h1>
      <p class="mt-2 text-sm text-gray-700">Result Dashboard</p>
    </div>
  </div>
        ...
        <table class="max-w-full divide-y divide-gray-300 w-full align"> <!-- Add w-full here -->
          <thead>
            <tr>
              ...
              <th scope="col" class="w-100 text-left text-sm font-semibold text-gray-900">Client Name</th>
              <th scope="col" class="px-3 py-3.5 text-mid text-sm font-semibold text-gray-900">Project Location</th>
              ...
              <th scope="col" class="px-3 py-3.5 text-mid text-sm font-semibold text-gray-900">Audit Fee</th>
          ...
          <tbody class="divide-y divide-gray-200">
            <tr>
              ...
              <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500 text-center">Palma</td>
              ...
              <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500 text-center"></td>
              <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500"></td>
              <td class="text-center">
                <a href="{{ route('livewire.pre-engagement.client-prospect-result1') }}" class="px-3 py-4 text-sm whitespace-nowrap text-blue-500 hover:text-blue-700">view
                </a>
            </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500 text-center">ITS</td>
              <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500 text-center">Arif Wijaksono</td>
              <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500 text-center">Aryo Wibisono</td>
              <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500 text-center"></td>
              <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500"></td>
