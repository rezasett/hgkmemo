...
<div class="px-4 sm:px-6 lg:px-8">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-base font-semibold text-gray-900">List Accepted Client</h1>
        ...
        <table class="max-w-full divide-y divide-gray-300 w-full align"> <!-- Add w-full here -->
          <thead>
            <tr>
              ...
              <th scope="col" class="px-3 py-3.5 text-mid text-sm font-semibold text-gray-900">Detail</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-gray-200">
            <tr>
              ...
              <td class="text-center">
                <a href="{{ route('livewire.pre-engagement.ongoing-c-lient1') }}" class="px-3 py-4 text-sm whitespace-nowrap text-blue-500 hover:text-blue-700">view
                </a>
              </td>
            </tr>
            <tr>
