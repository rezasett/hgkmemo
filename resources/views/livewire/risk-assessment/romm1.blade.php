  ...
  <div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-2xl font-semibold text-gray-900">RoMM</h1>
    ...
    <div class="px-4 sm:px-6 lg:px-8 mb-4 mr-250">
     <br>
        ...
        <tbody class="divide-y divide-gray-200">
          <tr>
            <td class="w-20 px-4 py-2 text-sm text-gray-700 border- border-gray-300 font-bold">Client Name</td>
            <td class="w-50 px-4 py-2  text-sm text-blue-600 border- border-gray-300 bg-gray-50"></td>
          </tr>
           <tr>
            <td class="w-20 px-4 py-2 text-sm text-gray-700 border-r border-gray-300 font-bold">TB Periode</td>
            <td class="w-50 px-4 py-2 text-sm text-blue-600 border-r border-gray-300 bg-gray-50"></td>
          </tr>
        </tbody>
        </table>
    </div>
    ...
    <table class="min-w-full border border-gray-300">
      <thead class="bg-gray-50 border border-gray-300">
        <tr>
          ...
          <th class="w-70 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Lead Account</th>
          <th class="w-70 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Balance</th>
          <th class="w-30 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Materiality Scoping</th>
          <th class="w-30 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Fraud Risk</th>
          <th class="w-30 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Inherent Risk</th>
          <th class="w-30 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Control Risk</th>
          <th class="w-30 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">RoMM</th>
