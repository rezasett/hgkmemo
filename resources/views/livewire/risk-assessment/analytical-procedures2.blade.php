...
<div class="flex-1 bg-white p-4 pl-0.5">
  ...
  <div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-2xl font-semibold text-gray-900">Analytical Procedures</h1>
        <p class="mt-2 text-xl text-gray-700">Account Level</p>
      </div>
    ...
    <div class="mt-8 px-4 sm:px-6 lg:px-6 mb-4 mr-250">
     <br>
  ...
  <div class="max-w-400 overflow-x-scroll px-4 py-5 sm:p-6">
    <table class="min-w-full border border-gray-300 ">
      <thead class="bg-gray-50 border border-gray-300">
        <tr>
          ...
          <th class="min-w-70 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300"> Balance (Current)</th>
          <th class="min-w-70 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Balance (Previous) </th>
          <th class="min-w-50 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">% Movement </th>
          <th class="min-w-50 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Result Cycle</th>
          <th class="min-w-50 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Result Account</th>
          <th class="min-w-50 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Final Result</th>
          <th class="min-w-100 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Notes </th>
        </th>
        </tr>
      </thead>
      <tbody class="divide-y divide-gray-200">
