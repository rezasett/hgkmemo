...
<div class="px-4 sm:px-6 lg:px-8">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-2xl font-bold text-gray-900 mb-4">Inherent Risk Dashboard</h1>
      <br>
          ...
          <tbody class="divide-y divide-gray-200">
            <tr>
             ...
             <td class="text-center">
                               <a href="{{route('livewire.risk-assessment.inherent-risk2')}}" class="px-3 py-4 text-sm whitespace-nowrap text-blue-500 hover:text-blue-700">view
                </a>
            </td>
            </tr>
            <tr>
