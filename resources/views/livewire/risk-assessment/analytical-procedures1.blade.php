  ...
  <div class="px-4 sm:px-6 lg:px-8">
    ...
    <br>
     ...
     <div class="flex justify-start gap-4">
        <a href="{{ route('livewire.risk-assessment.analytical-procedures2') }}" class="py-2 px-4 bg-blue-600 text-white rounded">Lead Account View</a>
     </div>
    </div>
    ...
    <table class="min-w-full border border-gray-300 ">
      <thead class="bg-gray-50 border border-gray-300">
        <tr>
          ...
          <th class="w-50 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Analytical Procedures</th>
          <th class="w-50 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">WP Analytical</th>
          <th class="w-50 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Analytical Result</th>
          <th class="w-50 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Risk</th>
          <th class="w-100 px-4 py-2 text-sm font-semibold text-gray-900 border-r border-gray-300">Notes</th>
        </th>
          </tr>
      </thead>
      <tbody class="divide-y divide-gray-300">
        <tr>
          <td class="px-4 py-6 text-sm text-gray-700 border-r border-gray-300"></td>
          <td class="px-4 py-6 text-sm text-gray-700 border-r border-gray-300">
