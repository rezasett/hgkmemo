...
<div class="px-4 sm:px-6 lg:px-8">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-2xl font-bold text-gray-900 mb-4">Analytical Procedures</h1>
      <br>
       <h1 class="text-base font-bold text-gray-900">Workdone</h1>
          ...
          <tbody class="divide-y divide-gray-200">
            <tr>
             ...
             <td class="text-center">
                               <a href="{{route('livewire.risk-assessment.analytical-procedures1')}}" class="px-3 py-4 text-sm whitespace-nowrap text-blue-500 hover:text-blue-700">view
                </a>
            </td>
            </tr>
            <tr>
  ...
  <br>
  <br>
    <h1 class="text-base font-bold text-gray-900">Pending Task</h1>
  <div class="mt-8 flow-root">
    <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
      <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8 w-full"> <!-- Add w-full here -->
        <table class="max-w-full divide-y divide-gray-300 w-full align"> <!-- Add w-full here -->
