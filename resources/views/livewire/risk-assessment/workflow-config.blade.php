...
<div class="px-4 sm:px-6 lg:px-8">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-base font-semibold text-gray-900">Workflow Configuration</h1>
        ...
        <table class="mt-4 max-w-full divide-y divide-gray-300 w-full align"> <!-- Add w-full here -->
          <thead>
            <tr>
              ...
              <th scope="col" class="min-w-30 text-mid text-sm font-semibold text-gray-900">Start Period</th>
              <th scope="col" class="min-w-30 text-mid text-sm font-semibold text-gray-900">End Period</th>
          ...
          <tbody class="divide-y divide-gray-200">
            <tr>
              ...
              <td class="px-3 py-4 text-sm text-center whitespace-nowrap text-gray-500">DD/MM/YYYY</td>
              <td class="px-3 py-4 text-sm text-center whitespace-nowrap text-gray-500">DD/MM/YYYY</td>
              <td class="text-center">
                <a href="{{ route('livewire.risk-assessment.workflow-config-detail') }}" class="px-3 py-4 text-sm whitespace-nowrap text-blue-500 hover:text-blue-700">view
                </a>
              </td>
