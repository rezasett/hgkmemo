...
<div class="px-4 sm:px-6 lg:px-8">
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-2xl font-semibold text-gray-900">Independence Auditor's Report Review</h1>
        ...
        <table class="max-w-full divide-y divide-gray-300 w-full align"> <!-- Add w-full here -->
          ...
          <tbody class="divide-y divide-gray-200">
            <tr>
              ...
              <td class="px-3 py-4 text-center text-sm whitespace-nowrap text-gray-500">Team Leader</td>
              <td class="text-center">
                <a href="{{ route('livewire.completing.i-a-r-review1') }}" class="px-3 py-4 text-sm whitespace-nowrap text-blue-500 hover:text-blue-700">view
                </a>
            </td>
            </tr>
            <tr>
